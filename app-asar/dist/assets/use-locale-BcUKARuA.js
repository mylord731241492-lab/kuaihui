import { dc as e, dd as t, de as a, df as n, bU as o } from "./index-Ct5UuHQN.js";
import { i as r, c as i } from "./vendor-DHo7BzsC.js";
const d = {
    name: "en-US",
  ...
  h = {
    ...
    formatDistance: (e, t, a) => {
      ...
      return (
        (n =
          "string" == typeof o ? o : 1 === t ? o.one : o.other.replace("{{count}}", t.toString())),
  ...
  c = { name: "en-US", locale: h };
function y(e) {
  const { mergedLocaleRef: t, mergedDateLocaleRef: a } = r(o, null) || {},
    n = i(() => {
      var a, n;
      return null !==
        (n = null === (a = null == t ? void 0 : t.value) || void 0 === a ? void 0 : a[e]) &&
        void 0 !== n
        ? n
        : d[e];
    });
  return {
    dateLocaleRef: i(() => {
      var e;
      return null !== (e = null == a ? void 0 : a.value) && void 0 !== e ? e : c;
    }),
    localeRef: n,
  };
}
export { h as e, y as u };
