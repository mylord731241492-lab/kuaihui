import { g as t } from "./_commonjsHelpers-Dvrxj_Zk.js";
var e,
  n,
  r = {};
var o,
...
function B() {
  ...
  return (
    ...
    (C.getTotalCodewordsCount = function (e, r) {
      switch (r) {
        case t.L:
          return n[4 * (e - 1) + 0];
        case t.M:
...
function J() {
  ...
  e = e.replace(/u/g, "\\u");
  const n = "(?:(?![A-Z0-9 $%*+\\-./:]|" + e + ")(?:.|[\r\n]))+";
  ((H.KANJI = new RegExp(e, "g")),
    (H.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g")),
    (H.BYTE = new RegExp(n, "g")),
    (H.NUMERIC = new RegExp(t, "g")),
    (H.ALPHANUMERIC = new RegExp("[A-Z $%*+\\-./:]+", "g")));
  const r = new RegExp("^" + e + "$"),
    o = new RegExp("^" + t + "$"),
    i = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
  return (
    (H.testKanji = function (t) {
      return r.test(t);
    }),
    (H.testNumeric = function (t) {
      return o.test(t);
    }),
    (H.testAlphanumeric = function (t) {
      return i.test(t);
    }),
    H
  );
      ...
      (function (t) {
        ...
        ((t.from = function (t, e) {
          ...
          (t.getCapacity = function (t, r, s) {
            ...
            void 0 === s && (s = o.BYTE);
            const u = 8 * (e.getSymbolTotalCodewords(t) - n.getTotalCodewordsCount(t, r));
          ...
          (t.getBestVersionForData = function (e, n) {
            ...
            return (function (e, n, r) {
              for (let o = 1; o <= 40; o++) if (n <= t.getCapacity(o, r, e)) return o;
      ...
      (function (t) {
            ...
            return (
              ...
              (n.prototype.write = function (t) {
                ...
                for (n = 0; n + 2 <= this.data.length; n += 2) {
                  let r = 45 * e.indexOf(this.data[n]);
                  ((r += e.indexOf(this.data[n + 1])), t.put(r, 11));
                }
                ...
                (rt.exports = t =
                  {
                    single_source_shortest_paths: function (e, n, r) {
                      ...
                      var s,
                        ...
                        l,
                        h,
                        g = t.PriorityQueue.make();
                      for (g.push(n, 0); !g.empty(); )
                        for (a in ((u = (s = g.pop()).value), (c = s.cost), (f = e[u] || {})))
                          f.hasOwnProperty(a) &&
                            ((l = c + f[a]),
                            (h = i[a]),
                            (void 0 === i[a] || h > l) && ((i[a] = l), g.push(a, l), (o[a] = u)));
        ...
        ((t.fromArray = function (t) {
          return t.reduce(function (t, e) {
            return (
              "string" == typeof e ? t.push(d(e, null)) : e.data && t.push(d(e.data, e.mode)),
              t
            );
          }, []);
        }),
          (t.fromString = function (n, r) {
            const o = (function (t) {
                ...
                for (let r = 0; r < t.length; r++) {
                  ...
                  switch (o.mode) {
                    ...
                    case e.ALPHANUMERIC:
                      ...
                      break;
                    case e.KANJI:
                      n.push([o, { data: o.data, mode: e.BYTE, length: f(o.data) }]);
                      break;
                    case e.BYTE:
                      n.push([{ data: o.data, mode: e.BYTE, length: f(o.data) }]);
                  }
                }
                return n;
              ...
              i = (function (t, n) {
                ...
                for (let s = 0; s < t.length; s++) {
                  ...
                  for (let t = 0; t < u.length; t++) {
                    const c = u[t],
                      f = "" + s + t;
                    (a.push(f), (r[f] = { node: c, lastCount: 0 }), (o[f] = {}));
                    for (let t = 0; t < i.length; t++) {
                      const s = i[t];
                      r[s] && r[s].node.mode === c.mode
                        ? ((o[s][f] =
                            g(r[s].lastCount + c.length, c.mode) - g(r[s].lastCount, c.mode)),
                          (r[s].lastCount += c.length))
                        : (r[s] && (r[s].lastCount = c.length),
                          (o[s][f] = g(c.length, c.mode) + 4 + e.getCharCountIndicator(c.mode, n)));
                    }
                  }
                  i = a;
                }
              ...
              u = [];
            for (let t = 1; t < s.length - 1; t++) u.push(i.table[s[t]].node);
            return t.fromArray(
              (function (t) {
                return t.reduce(function (t, e) {
          ...
          (t.rawSplit = function (e) {
            return t.fromArray(h(e, a.isKanjiModeEnabled()));
          }));
      })(G)),
    G
  );
...
function it() {
  ...
  const t = u(),
    ...
    r = (function () {
      ...
      return (
        ...
        (t.prototype.xor = function (t, e, n) {
          this.data[t * this.size + e] ^= n;
        }),
        (t.prototype.isReserved = function (t, e) {
          ...
          ((t.isValid = function (t) {
            ...
            (t.getBestMask = function (e, n) {
              ...
              for (let s = 0; s < r; s++) {
                (n(s), t.applyMask(s, e));
                const r =
                  t.getPenaltyN1(e) + t.getPenaltyN2(e) + t.getPenaltyN3(e) + t.getPenaltyN4(e);
    ...
    I = (function () {
      ...
      _ = 1;
      const t = u(),
        e = t.getBCHDigit(1335);
      return (
        (j.getEncodedBits = function (n, r) {
          const o = (n.bit << 3) | r;
          let i = o << 10;
          for (; t.getBCHDigit(i) - e >= 0; ) i ^= 1335 << (t.getBCHDigit(i) - e);
          return 21522 ^ ((o << 10) | i);
        }),
        j
      );
  ...
  function L(e, r, o) {
    ...
    const s = 8 * (t.getSymbolTotalCodewords(e) - g.getTotalCodewordsCount(e, r));
    for (i.getLengthInBits() + 4 <= s && i.put(0, 4); i.getLengthInBits() % 8 != 0; ) i.putBit(0);
    const u = (s - i.getLengthInBits()) / 8;
    for (let t = 0; t < u; t++) i.put(t % 2 ? 17 : 236, 8);
    return (function (e, n, r) {
      const o = t.getSymbolTotalCodewords(n),
        i = g.getTotalCodewordsCount(n, r),
        s = o - i,
        u = g.getBlocksCount(n, r),
        a = o % u,
        c = u - a,
        f = Math.floor(o / u),
        l = Math.floor(s / u),
      ...
      for (let t = 0; t < u; t++) {
        const e = t < c ? l : h;
        ((m[t] = A.slice(w, w + e)), (E[t] = p.encode(m[t])), (w += e), (y = Math.max(y, e)));
      }
      const C = new Uint8Array(o);
      let B,
        I,
        M = 0;
      for (B = 0; B < y; B++) for (I = 0; I < u; I++) B < m[I].length && (C[M++] = m[I][B]);
      for (B = 0; B < d; B++) for (I = 0; I < u; I++) C[M++] = E[I][B];
      return C;
    })(i, e, r);
  }
  function U(e, n, i, u) {
    let c;
    if (Array.isArray(e)) c = P.fromArray(e);
    else {
      if ("string" != typeof e) throw new Error("Invalid data");
      {
        let t = n;
        if (!t) {
          const n = P.rawSplit(e);
          t = C.getBestVersionForData(n, i);
        }
        c = P.fromString(e, t || 40);
      }
    }
    const f = C.getBestVersionForData(c, i);
    ...
    return (
      ...
      isNaN(u) && (u = a.getBestMask(g, b.bind(null, g, i))),
      a.applyMask(u, g),
      b(g, i, u),
      { modules: g, version: n, errorCorrectionLevel: i, maskPattern: u, segments: c }
    );
  }
  return (
    (i.create = function (n, r) {
      ...
      return (
        void 0 !== r &&
          ((s = e.from(r.errorCorrectionLevel, e.M)),
          (o = C.from(r.version)),
          (i = a.from(r.maskPattern)),
          ...
          (t.qrToImageData = function (e, n, r) {
            ...
            for (let t = 0; t < u; t++)
              for (let n = 0; n < u; n++) {
                let f = 4 * (t * u + n),
                  l = r.color.light;
                if (t >= a && n >= a && t < u - a && n < u - a) {
                  l = c[i[Math.floor((t - a) / s) * o + Math.floor((n - a) / s)] ? 1 : 0];
                }
                ((e[f++] = l.r), (e[f++] = l.g), (e[f++] = l.b), (e[f] = l.a));
              }
          }));
      })(ct)),
    ct
...
function pt() {
  ...
  return (
    (dt.render = function (r, o, i) {
      const s = t.getOptions(o),
        u = r.modules.size,
        a = r.modules.data,
        c = u + 2 * s.margin,
        f = s.color.light.a
          ? "<path " + e(s.color.light, "fill") + ' d="M0 0h' + c + "v" + c + 'H0z"/>'
          : "",
        l =
          "<path " +
          e(s.color.dark, "stroke") +
          ' d="' +
          (function (t, e, r) {
            let o = "",
              i = 0,
            ...
            for (let a = 0; a < t.length; a++) {
              ...
              (c || s || (s = !0),
                t[a]
                  ? (u++,
                    (a > 0 && c > 0 && t[a - 1]) ||
                      ((o += s ? n("M", c + r, 0.5 + f + r) : n("m", i, 0)), (i = 0), (s = !1)),
                    (c + 1 < e && t[a + 1]) || ((o += n("h", u)), (u = 0)))
                  : i++);
            }
            return o;
          })(a, u, s.margin) +
        ...
        g =
          ...
          l +
          "</svg>\n";
      return ("function" == typeof i && i(null, g), g);
    }),
    dt
  );
}
const wt = t(
  (function () {
    ...
    function u(e, n, r, i, s) {
      ...
      if (!c && !t()) throw new Error("Callback required as last argument");
      if (!c) {
        if (a < 1) throw new Error("Too few arguments provided");
        return (
          1 === a
            ? ((r = n), (n = i = void 0))
            : 2 !== a || n.getContext || ((i = r), (r = n), (n = void 0)),
          new Promise(function (t, s) {
            try {
              const s = o.create(r, i);
              t(e(s, n, i));
            } catch (u) {
              s(u);
            }
      ...
      2 === a
        ? ((s = r), (r = n), (n = i = void 0))
        : 3 === a &&
          (n.getContext && void 0 === s
            ? ((s = i), (i = void 0))
            : ((s = i), (i = r), (r = n), (n = void 0)));
      try {
        const t = o.create(r, i);
        s(null, e(t, n, i));
      } catch (f) {
        s(f);
      }
    ...
    return (
      ...
      (r.toString = u.bind(null, function (t, e, n) {
        return s.render(t, n);
      })),
      r
    );
