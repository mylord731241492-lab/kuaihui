...
function p(e, n) {
  ...
  if (!a)
    return void 0 !== r
      ? { checkedKeys: d(t, r), indeterminateKeys: Array.from(i) }
      : void 0 !== o
        ? { checkedKeys: u(t, o), indeterminateKeys: Array.from(i) }
        : { checkedKeys: Array.from(t), indeterminateKeys: Array.from(i) };
  const { levelTreeNodeMap: f } = n;
  let h;
  h =
    void 0 !== o
      ? g(o, t, n, c)
    ...
    for (const t of n) {
      ...
      (o && !a
        ? (y &&
          ...
          v.add(n))
        : i && N.add(n),
        e && p && v.has(n) && v.delete(n));
    }
  }
  return { checkedKeys: Array.from(v), indeterminateKeys: Array.from(N) };
}
function k(e, n, o, i) {
  const { treeNodeMap: a, getChildren: l } = n,
    s = new Set(),
    c = new Set(e);
  return (
    e.forEach((e) => {
...
function N(e, n, { loop: t = !1, includeDisabled: r = !1 } = {}) {
  const o = "prev" === n ? w : v,
    i = { reverse: "prev" === n };
  let a = !1,
    l = null;
...
function A(e, n, t, r, o, i = null, a = 0) {
  const l = [];
  return (
    e.forEach((s, c) => {
      var d;
      ...
      if (
        ...
        const e = o(s);
        Array.isArray(e) && (u.children = A(e, n, t, r, o, u, a + 1));
      }
      (l.push(u),
        n.set(u.key, u),
        t.has(a) || t.set(a, []),
        null === (d = t.get(a)) || void 0 === d || d.push(u));
    }),
    l
  );
}
function L(e, t = {}) {
  ...
  const d = new Map(),
    u = new Map(),
    { getDisabled: h = l, getIgnored: y = a, getIsGroup: g = f, getKey: k = i } = t,
    v = null !== (r = t.getChildren) && void 0 !== r ? r : o,
    N = t.ignoreEmptyChildren
      ? (e) => {
          const n = v(e);
  ...
  const K = {
            ...
            n.forEach((n) => {
              (r.push(n),
                n.isLeaf ||
                  !n.children ||
                  n.ignored ||
                  ((n.isGroup || void 0 === t || t.has(n.key)) && e(n.children)));
            });
          })(e),
          r
        );
    ...
    getPath: (e, n = {}) =>
      (function (e, { includeGroup: n = !1, includeSelf: t = !0 }, r) {
        var o;
